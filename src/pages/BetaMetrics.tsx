    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-7xl mx-auto px-4 py-8 space-y-6">
        <div className="grid gap-4 md:grid-cols-4">
          <Card><CardHeader className="pb-3"><CardTitle className="text-sm font-medium text-muted-foreground">Public Accounts (platform)</CardTitle></CardHeader><CardContent><div className="text-3xl font-bold">{formatMetric(metrics?.totalUsers)}</div></CardContent></Card>
