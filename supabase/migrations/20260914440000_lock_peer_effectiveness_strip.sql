-- Peer INSERT: strip client effectiveness_score invent.
-- Self-reported after-health belongs in notes; peer AVG only uses verified/server scores.
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    NEW.cost_usd := NULL;
    -- Client after-health invent must not enter peer effectiveness averages.
