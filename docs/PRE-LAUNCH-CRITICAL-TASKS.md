...
1. Apply pending Supabase migrations through `20260914400000` (peer-insert/beta-metrics/coop/dirt; prior `20260914390000` peer-sample/success-insert/weather; prior `20260914380000` catalog/community/variety/money-caps; prior `20260914370000` coop-alert-coop-match/ai-update/dirt; prior success/peer-cost/recommendation-update;
