...
Latest migration in repo: `20260914450000_scrub_peer_effectiveness_history`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914450000_scrub_peer_effectiveness_history`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914450000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914450000_…`)
