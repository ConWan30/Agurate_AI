...
**Evidence receipt:** paste Supabase migration history showing tip `20260914390000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914390000_…`)
