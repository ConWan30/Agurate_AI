...
Latest migration in repo: `20260914410000_lock_peer_crop_bind_cost_strip`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914410000_lock_peer_crop_bind_cost_strip`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914410000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914410000_…`)
