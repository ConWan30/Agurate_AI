...
Latest migration in repo: `20260914420000_lock_coop_alert_severity_crop_acres`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914420000_lock_coop_alert_severity_crop_acres`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914420000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914420000_…`)
