...
Latest migration in repo: `20260914400000_lock_peer_insert_beta_metrics_coop_dirt`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914400000_lock_peer_insert_beta_metrics_coop_dirt`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914400000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914400000_…`)
