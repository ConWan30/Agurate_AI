...
Latest migration in repo: `20260914340000_lock_coop_member_insert_and_insight_metrics`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914340000_lock_coop_member_insert_and_insight_metrics`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914340000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914340000_…`)
