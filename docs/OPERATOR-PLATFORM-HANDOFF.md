...
Latest migration in repo: `20260914460000_scrub_weather_events_gps_catalog`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914460000_scrub_weather_events_gps_catalog` (also apply prior `20260914450000_scrub_peer_effectiveness_history`)  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914460000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914460000_…`)
