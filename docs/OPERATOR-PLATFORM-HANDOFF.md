...
Latest migration in repo: `20260914330000_lock_claim_story_peer_link_metrics`

## 1. Apply Supabase migrations

Apply **all** pending migrations through tip  
`20260914330000_lock_claim_story_peer_link_metrics`  
...
**Evidence receipt:** paste Supabase migration history showing tip `20260914330000_…` applied with no errors.
...
- [ ] Migrations applied through tip (`20260914330000_…`)
